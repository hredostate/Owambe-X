...
import { Coins, PartyPopper, Tv, LayoutDashboard, Wallet, LogIn, Github } from 'lucide-react';
      ...
      <div className="min-h-screen flex flex-col">
        <header className="sticky top-0 z-50 border-b border-white/10 bg-black/60 backdrop-blur-md">
          <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <Link to="/" className="text-sm font-medium hover:text-purple-400 transition-colors">Find Party</Link>
              <Link to="/wallet" className="flex items-center gap-1.5 p-2 bg-white/5 rounded-full hover:bg-white/10 transition-colors border border-white/10 px-4">
        ...
        <main className="flex-1 overflow-auto">
          <Routes>
            ...
            <Route path="/screen/:id" element={<ScreenMode />} />
